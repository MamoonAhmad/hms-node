...
const administrationItems = [
  ...
  { name: 'Chief Complaints', href: '/administration/chief-complaint', icon: MessageSquare },
  { name: 'Procedure Categories', href: '/administration/procedure-categories', icon: FolderTree },
  { name: 'Procedure Codes', href: '/administration/procedure-codes', icon: Code },
...
const patientManagementItems = [
  ...
  { name: 'Patient Dashboard', href: '/patient-dashboard', icon: ClipboardList },
];

const laboratoryManagementItems = [
  { name: 'Laboratory Dashboard', href: '/laboratory-management', icon: LayoutDashboard },
  { name: 'Specimen Collection', href: '/laboratory-management/specimen-collection', icon: FlaskConical },
  { name: 'Specimen Transport', href: '/laboratory-management/specimen-transport', icon: FlaskConical },
  { name: 'Specimen Receiver', href: '/laboratory-management/specimen-receiver', icon: FlaskConical },
  { name: 'Lab Order Transport', href: '/laboratory-management/lab-order-transport', icon: FlaskConical },
  { name: 'Lab Report Received', href: '/laboratory-management/lab-report-received', icon: FlaskConical },
  { name: 'Result Management', href: '/laboratory-management/result-management', icon: FlaskConical },
  { name: 'Test Catalog', href: '/laboratory-management/test-catalog', icon: FlaskConical },
];

const radiologyManagementItems = [
  { name: 'Radiology Dashboard', href: '/radiology-management', icon: Camera },
  { name: 'Order Management', href: '/radiology-management/order-management', icon: Camera },
];

const pharmacyItems = [
  { name: 'Dashboard', href: '/pharmacy', icon: LayoutDashboard },
  { name: 'Medication Analytics', href: '/pharmacy?report=medication', icon: Pill },
  { name: 'Inventory Reports', href: '/pharmacy?report=inventory', icon: Pill },
  { name: 'Medication Prescriptions', href: '/pharmacy/e-prescribe-med-reconciliation', icon: Pill },
];
...
const onsiteOrdersSections = [
  { title: 'Laboratory Management', icon: FlaskConical, items: laboratoryManagementItems },
  { title: 'Pharmacy', icon: Pill, items: pharmacyItems },
  { title: 'Radiology Management', icon: Camera, items: radiologyManagementItems },
];
          ...
          {sections.map((section, idx) => {
            ...
            return (
              <div key={section.title} className="space-y-1">
                <button
                  onClick={() => setOpenSectionIndex(isSectionOpen ? null : idx)}
                  className={cn(
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-1 p-4 overflow-y-auto">
        ...
        {!isCollapsed && <div className="border-t border-sidebar-border py-2" />}
