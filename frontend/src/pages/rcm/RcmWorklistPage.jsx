...
import {
  ...
  formatWaitingTime,
  todayIsoDate,
} from '@/pages/encounters-work-list/encountersWorkListConstants';
...
export function RcmWorklistPage() {
  ...
  const handleCreateClaim = (row) => {
    navigate(`/rcm/cms-1500?encounterId=${row.id}`);
  };
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">RCM Worklist</h1>
          <p className="text-muted-foreground">
            Eligible encounters ready for assignment and CMS-1500 claim creation
          </p>
        </div>
      ...
      <DataTable
        ...
        actions={(row) => (
          <RowActionsMenu disabled={actionLoading}>
            ...
            <RowActionsMenuItem onClick={() => handleCreateClaim(row)}>
              Create claim
            </RowActionsMenuItem>
          </RowActionsMenu>
        )}
