...
export const labTestApi = {
  async getAll(params = {}) {
    ...
    if (params.specimenType) searchParams.set('specimenType', params.specimenType);
    ...
    const response = await fetch(`${API_BASE_URL}/lab-tests?${searchParams}`, {
  ...
  async getActive() {
    const response = await fetch(`${API_BASE_URL}/lab-tests/active`, {
      headers: getAuthHeaders(),
    });
    return handleResponse(response);
  },
